...
function search() {
    ...
    Array.from(products).map((product)=>{
        /* Check README.md for more information about firstChild and firstElementChild */ // Grabbing each product title
        ...
        if (lowerCasedProductTitle.indexOf(lowerCasedSearchingVal) !== -1) product.style.display = "block";
...
},{}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequirefb81")
